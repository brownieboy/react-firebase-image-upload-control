(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("firebase/storage"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "firebase/storage"], factory);
	else if(typeof exports === 'object')
		exports["rfiu"] = factory(require("react"), require("firebase/storage"));
	else
		root["rfiu"] = factory(root["react"], root["firebase/storage"]);
})(global, (__WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_firebase_storage__) => {
...
const storage_1 = __webpack_require__(/*! firebase/storage */ "firebase/storage");
const uniqBy_1 = __importDefault(__webpack_require__(/*! lodash/fp/uniqBy */ "./node_modules/lodash/fp/uniqBy.js"));
const pretty_bytes_1 = __importDefault(__webpack_require__(/*! pretty-bytes */ "./node_modules/pretty-bytes/index.js"));
// @ts-ignore
const ImageDrop_1 = __importDefault(__webpack_require__(/*! ./ImageDrop */ "./src/ImageDrop.tsx"));
const styles = {
    imagePreview: {
        maxHeight: 150,
        maxWidth: 200
...
const FirebaseUploadImage = ({ firebaseApp, storageFolder = "rfiu", disabled = false, multiple = false, options = {
    styles: {
        imgPreview: {},
        imgPreviewLabel: {},
        progressControlWrapper: {}
    }
}, progressControl, checkboxControl, buttonControl, uploadButtonIcon, removeButtonIcon, uploadStartCallback, uploadCompleteCallback }) => {
    var _a, _b;
    const [filesToStore, setFilesToStore] = (0, react_1.useState)([]);
    const [filesToRemove, setFilesToRemove] = (0, react_1.useState)([]);
    const [uploadState, setUploadState] = (0, react_1.useState)({});
    const [uploadButtonClicked, setUploadButtonClicked] = (0, react_1.useState)(false);
    ...
    const handleImageChange = (acceptedFilesArray) => {
        if (multiple) {
            const uniqueFilesArray = (0, uniqBy_1.default)(e => e.name, [...filesToStore, ...acceptedFilesArray]).map(file => 
            ...
            setFilesToStore(acceptedFilesArray.map(file => Object.assign(file, {
                preview: URL.createObjectURL(file)
            })));
        }
    ...
    const handleProgress = (percent, fileName) => {
        setUploadState((prevState) => {
            return Object.assign(Object.assign({}, prevState), { [fileName]: percent });
        });
    };
    const startUpload = () => __awaiter(void 0, void 0, void 0, function* () {
        if (uploadStartCallback) {
            uploadStartCallback(filesToStore);
        }
        setUploadButtonClicked(true);
        filesToStore.forEach(file => {
            const storageRef = (0, storage_1.ref)(storage, `${storageFolder}/${file.name}`);
            ...
            uploadTask.on("state_changed", snapshot => {
                ...
                const fileName = (_b = (_a = uploadTask === null || uploadTask === void 0 ? void 0 : uploadTask.snapshot) === null || _a === void 0 ? void 0 : _a.ref) === null || _b === void 0 ? void 0 : _b.name;
                handleUploadSuccess(fileName, downloadUrl);
            }));
        });
    });
    const handleUploadSuccess = (fileName, downloadUrl) => __awaiter(void 0, void 0, void 0, function* () {
        setFilesToStore(prevState => {
            const currentFileIndex = prevState.findIndex(member => member.name === fileName);
            ...
            if (uploadCompleteCallback) {
                const filesWithDownloadUrls = newState.filter(member => member.downloadUrl);
    ...
    const handleFileRemovalCheck = (event) => {
        ...
        if (event.target.checked) {
            setFilesToRemove([...filesToRemove, (_a = event === null || event === void 0 ? void 0 : event.target) === null || _a === void 0 ? void 0 : _a.value]);
        }
        else {
            setFilesToRemove(filesToRemove.filter(member => member !== event.target.value));
        }
    };
    ...
    const imgPreviewStyles = Object.assign(Object.assign({}, styles.imagePreview), (_a = options === null || options === void 0 ? void 0 : options.styles) === null || _a === void 0 ? void 0 : _a.imgPreview);
    const imgPreviewTitleStyles = Object.assign(Object.assign({}, styles.imagePreviewTitle), (_b = options === null || options === void 0 ? void 0 : options.styles) === null || _b === void 0 ? void 0 : _b.imgPreviewTitle);
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(ImageDrop_1.default, { onDrop: handleImageChange, multiple: multiple }),
        react_1.default.createElement("div", { style: {
            ...
            ? filesToStore.map(file => {
                var _a;
                return (react_1.default.createElement("div", { key: file.name, style: {
                        display: "flex",
                        flexDirection: "column",
                    ...
                    react_1.default.createElement("img", { src: file.preview, title: file.name, alt: file.name, style: imgPreviewStyles }),
                    react_1.default.createElement("div", { style: imgPreviewTitleStyles },
                        react_1.default.createElement("label", { htmlFor: file.name, style: (_a = options === null || options === void 0 ? void 0 : options.styles) === null || _a === void 0 ? void 0 : _a.imgPreviewLabel }, `${file.name} (${(0, pretty_bytes_1.default)(file.size)})`),
                        react_1.default.createElement(CheckboxControl, { checked: filesToRemove.includes(file.name), onChange: handleFileRemovalCheck, id: file.name, value: file.name }))));
            })
            : null),
        react_1.default.createElement("div", { style: { display: "flex", alignItems: "center" } },
            react_1.default.createElement(ButtonControl, { variant: "contained", onClick: handleRemoveFiles, style: { textTransform: "none", marginTop: 10, marginRight: 10 }, disabled: filesToRemove.length === 0 },
                removeButtonIcon ? (react_1.default.createElement(RemoveButtonIcon, { style: { marginRight: 10 } })) : null,
                "Remove checked files"),
            react_1.default.createElement(ButtonControl, { color: "primary", variant: "contained", onClick: startUpload, style: { textTransform: "none", marginTop: 10, marginRight: 10 }, disabled: disabled || filesToStore.length === 0 },
                uploadButtonIcon ? (react_1.default.createElement(UploadButtonIcon, { style: { marginRight: 10 } })) : null,
                filesToStore.length > 1 ? "Upload all" : "Upload")),
        react_1.default.createElement("div", { style: { display: "flex", alignItems: "center", marginTop: 10 } }, uploadButtonClicked &&
            filesToStore.map(file => {
                var _a;
                return (react_1.default.createElement(ProgressControl, { value: uploadState[file.name] || 0, key: file.name, component: progressControl, componentWrapperStyles: (_a = options === null || options === void 0 ? void 0 : options.styles) === null || _a === void 0 ? void 0 : _a.progressControlWrapper, fileName: file.name }));
            }))));
};
...
const StyledDropzone = (props) => {
    const { getRootProps, getInputProps, isDragActive, isDragAccept, isDragReject } = (0, react_dropzone_1.useDropzone)(Object.assign({ accept: {
            "image/*": []
        } }, props));
    const style = (0, react_1.useMemo)(() => (Object.assign(Object.assign(Object.assign(Object.assign({}, baseStyle), (isDragActive ? activeStyle : {})), (isDragAccept ? acceptStyle : {})), (isDragReject ? rejectStyle : {}))), [isDragActive, isDragAccept, isDragReject]);
    const message = (props === null || props === void 0 ? void 0 : props.multiple)
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_firebase_storage__;
